...
## Download & install (v0.5.1)

Download from the [GitHub Releases page](https://github.com/luishg/open-os-cli/releases/tag/v0.5.1).

### AppImage (any Linux distro)

| File | Size |
|---|---|
| [`open-os-cli-0.5.1.AppImage`](https://github.com/luishg/open-os-cli/releases/download/v0.5.1/open-os-cli-0.5.1.AppImage) | ~105 MB |

```bash
chmod +x open-os-cli-0.5.1.AppImage
./open-os-cli-0.5.1.AppImage
```
...
| File | Size |
|---|---|
| [`open-os-cli-0.5.1.pacman`](https://github.com/luishg/open-os-cli/releases/download/v0.5.1/open-os-cli-0.5.1.pacman) | ~73 MB |

```bash
sudo pacman -U open-os-cli-0.5.1.pacman
```
...
| File | Size |
|---|---|
| [`open-os-cli_0.5.1_amd64.deb`](https://github.com/luishg/open-os-cli/releases/download/v0.5.1/open-os-cli_0.5.1_amd64.deb) | ~73 MB |

```bash
sudo dpkg -i open-os-cli_0.5.1_amd64.deb
```
...
| File | Size |
|---|---|
| [`open-os-cli-0.5.1.x86_64.rpm`](https://github.com/luishg/open-os-cli/releases/download/v0.5.1/open-os-cli-0.5.1.x86_64.rpm) | ~73 MB |

```bash
sudo dnf install open-os-cli-0.5.1.x86_64.rpm
```
...
| File | Size |
|---|---|
| [`open-os-cli-0.5.1-universal.dmg`](https://github.com/luishg/open-os-cli/releases/download/v0.5.1/open-os-cli-0.5.1-universal.dmg) | ~150 MB |
...
| File | Size |
|---|---|
| [`open-os-cli.Setup.0.5.1.exe`](https://github.com/luishg/open-os-cli/releases/download/v0.5.1/open-os-cli.Setup.0.5.1.exe) | ~78 MB |
